...
export function CommunityWallBento() {
  return (
    <motion.div initial="initial" whileHover="hover">
      <BentoCard linkTo="/illustrations" height="h-[276px]">
        {/* Dots */}
        ...
        <div className="grid h-full grid-cols-2 grid-rows-2 items-end gap-8">
          <div className="col-1 z-10 row-start-2">
            <h2 className="mb-2 font-medium">Digital Illustration</h2>
            <p className="text-text-secondary">My art and paintings</p>
          </div>
        </div>
      </BentoCard>
    </motion.div>
